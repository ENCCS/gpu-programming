...
! Incorporate the OpenACC directive to update data stored in f on the CPU (i.e. copy data from GPU to CPU)
!$acc ......
...
! Incorporate the OpenACC directive to transfer the updated data to GPU
!$acc ....... 
