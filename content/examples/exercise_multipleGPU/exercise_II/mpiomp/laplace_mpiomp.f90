...
! Incorporate the OpenMP directive to update data stored in f on the CPU (i.e. copy data from GPU to CPU)
!$omp ......
...
! Incorporate the OpenMP directive to transfer the updated data to GPU
!$omp ....... 
