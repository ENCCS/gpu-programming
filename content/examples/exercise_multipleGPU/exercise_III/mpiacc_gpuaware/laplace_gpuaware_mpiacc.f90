...
! Incorporate the OpenACC directive *host_data use_device()* to pass a device pointer to MPI_Send and MPI_Recv.
!$acc .......
...
!Incorporate the OpenACC directive *host_data use_device()* to pass a device pointer to the MPI_Allreduce.
