...
As an exercise, modify the "Hello World" code to explicitly use a specific GPU. We can do this by using the **<cuda/hip>SetDevice** function, which allows us to set the desired GPU device. 
