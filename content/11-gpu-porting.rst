...
Exercises for how to use ``Hipify-perl`` and ``Hipify-clang`` tools can be accessed `here <examples/exercise_hipify>`___.  
...
Exercises for how to use ``Clacc`` tool can be accessed `here <examples/exercise_clacc>`____.
